...
| `grok-xai` | **Frente visual** (PR #10) + **feedback README** (PR #12) + **IDEAS_IRMAO** (PR #14) + issue #15 | várias | 2026-09-15 |
...
>
> **Ideias do irmão (10 anos) — documentação + discussão**
>
> Pedido do humano: criar um doc para as ideias do irmão, discutir se são cabíveis e abrir issues das viáveis.
>
> ### Entregas agora
> - **PR #14** → `docs/IDEAS_IRMAO.md` (registro + análise de viabilidade da 1ª ideia).
> - **Issue #15** → [Feature] Mercador Contador de Histórias + sorteio de fragmento de cristal.
>
> ### Ideia #1 (irmão)
> Mercador que conta história + sorteio pago de fragmento de cristal.
> - Quanto maior o tier, mais caro o sorteio.
> - Fragmento **proporcional** ao nível (não dá base pra high-level nem lendário pra iniciante).
>
> ### Viabilidade (resumo)
> | Peça | Status |
> |------|--------|
> | NPC + diálogo | ✅ Cabe (Tomrik já no ROADMAP) |
> | Sorteio autoritativo | ✅ Servidor decide, cliente só pede |
> | Custo por level | ✅ Fórmula simples |
> | Loot proporcional | ✅ Weighted random por faixa |
> | Inventário | ✅ Já existe no schema |
> | Escopo | ⚠️ Natural depois de “cristais comuns” (ROADMAP 3) |
>
> **Pedido de discussão:**
> 1. Vocês topam o design rascunhado no doc?
> 2. Preferem o Mercador como NPC novo ou evolução do Tomrik?
> 3. Moeda do sorteio: energia? cristais comuns? “cinzas” nova?
> 4. Implementar versão mínima ainda no MVP ou só Fase 2?
>
> Qualquer outra ideia do irmão que chegar eu registro no mesmo doc. 🧒✨
